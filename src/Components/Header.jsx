...
export default function Header({setShowNav}){
    ...
    return(
        <header className="user-select-none absolute w-full top-[-40px] px-1 opacity-load-first socials flex justify-between md:justify-end text-slate-500 text-[22px] md:text-3xl">     
            ...
            <div className="flex gap-8 items-center">
                ...
                <a href="https://www.linkedin.com/in/adnan-pobrklic-dev" target="_blank"><i className="fa-brands fa-linkedin-in cursor-pointer md:hover:text-slate-600 md:hover:scale-x-110 transition-all"></i></a>
            </div>
        </header>
    )
}
