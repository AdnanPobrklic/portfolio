...
export default function Header({setShowNav}){
    ...
    return(
        <header className="user-select-none absolute w-full top-[-40px] px-1 opacity-load-first socials flex justify-between md:justify-end text-slate-500 text-[28px] md:text-3xl">     
